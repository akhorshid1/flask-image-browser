...
animals = set(['American Staffordshire terrier', 'papillon', 'Mexican hairless',
           ...
           'Saint Bernard', 'toy poodle', 'miniature poodle',
...
#    plot.min_border = 80
    ...
    im2 = Image.open('data/men/' + dataframe['File Name'][0] + '.jpg')
    ...
    p2.background_fill_color = "#234567"
...
#    plot.min_border = 80
    ...
    im3 = Image.open('data/men/' + dataframe['File Name'][1] + '.jpg')
    ...
    p3.background_fill_color = "#234567"
    p3.border_fill_color = "#234567"
#    plot.min_border = 80
    ...
    im4 = Image.open('data/men/' + dataframe['File Name'][2] + '.jpg')
    ...
    p4.background_fill_color = "#234567"
    p4.border_fill_color = "#234567"
#    plot.min_border = 80
