...
#        plt.show()
    ...
    def plot_single_figure(self):
        ...
        self.df = pd.read_csv('/Users/akhorshid/Documents/Python/flask-image-browser/women.csv')
        self.df = self.df[['File Name', 'Truncated Description', 'Certainty']]
...
#        fig = plt.figure(figsize = (12,8))
        ...
        tile = Image.open('/Users/akhorshid/Documents/Python/flask-image-browser/data/women/' + file_name + '.jpg')
        plt.imshow(tile)
#        plt.title(str(file_values[0]) + ' (score = ' + str(file_score[0]) + ')', fontsize = 16, fontweight = 'bold')
#        plt.title(str(file_values[0]), fontsize = 16, fontweight = 'bold')
        plt.title('Staffordshire terrier', fontsize = 16, fontweight = 'bold')
        plt.show()
        
    
            
main_class = main()
file = main_class.plot_single_figure()
